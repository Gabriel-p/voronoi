...
plt.minorticks_on()
# Set grid
plt.grid(b=True, which='major', color='gray', linestyle='-', lw=0.5, zorder=1)
plt.grid(b=True, which='minor', color='gray', linestyle='-', lw=0.5, zorder=1)
# Print radii for Voronoi groups.
for c_x, c_y, r in zip(*[c_x, c_y, r]):
    circle = plt.Circle((c_x, c_y), r, color='g',
                        fill=False, lw=1.2)
